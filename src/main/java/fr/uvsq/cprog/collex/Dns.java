...
public class Dns {
                ...
                for (String line : lines) {
                    ...
                    if (parts.length == 2) {
                        try {
                            ...
                            System.err.println("Ligne invalide dans la base de données ignorée: " + line + " - " + e.getMessage());
                        }
                    }
                }
            }
    ...
    private void updateDatabaseFile() {
        if (this.dbFilePath == null) {
            System.err.println("Le chemin du fichier de base de données n'est pas configuré. La mise à jour est impossible.");
            return;
        }
        Path dbPath = Paths.get(this.dbFilePath);
        ...
        try {
            ...
            System.err.println("Erreur lors de la mise à jour du fichier de base de données: " + e.getMessage());
        }
    }
}
